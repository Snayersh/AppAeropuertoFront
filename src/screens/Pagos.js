...
const Pagos = ({ route, navigation }) => {
    ...
    if (verificandoGuardia) return <ActivityIndicator size="large" color="#0d47a1" style={{ flex: 1, justifyContent: 'center' }} />;
                ...
                <View style={styles.paymentCard}>
                    {!pagado ? (
                        <>
                            ...
                            <TextInput style={[styles.input, { textTransform: 'uppercase' }]} placeholder="Ej: B-A1B2C" autoCapitalize="characters" value={codigoReserva} onChangeText={setCodigoReserva} />
                            ...
                            <View style={styles.ccBox}>
                                ...
                                <TextInput style={styles.ccInput} placeholder="0000 0000 0000 0000" placeholderTextColor="rgba(255,255,255,0.4)" keyboardType="numeric" value={tarjeta} onChangeText={handleTarjetaChange} />

                                <View style={styles.ccRow}>
                                    <View style={{ flex: 1, marginRight: 10 }}>
                                        <Text style={styles.ccLabel}>Vencimiento</Text>
                                        <TextInput style={styles.ccInput} placeholder="MM/YY" placeholderTextColor="rgba(255,255,255,0.4)" keyboardType="numeric" value={vencimiento} onChangeText={handleVencimientoChange} />
                                    </View>
                                    <View style={{ flex: 1 }}>
                                        <Text style={styles.ccLabel}>CVV</Text>
                                        <TextInput style={styles.ccInput} placeholder="123" placeholderTextColor="rgba(255,255,255,0.4)" keyboardType="numeric" secureTextEntry value={cvv} onChangeText={handleCVVChange} />
                                    </View>
                                </View>

                                <Text style={styles.ccLabel}>Nombre en la tarjeta</Text>
                                <TextInput style={[styles.ccInput, { textTransform: 'uppercase' }]} placeholder="JUAN PEREZ" placeholderTextColor="rgba(255,255,255,0.4)" autoCapitalize="characters" value={nombreTitular} onChangeText={setNombreTitular} />
                            </View>

                            <TouchableOpacity style={styles.btnSuccess} onPress={procesarPago} disabled={cargando}>
                        ...
                        <View style={styles.successContainer}>
                            ...
                            <TouchableOpacity style={[styles.btnSuccess, { marginTop: 30 }]} onPress={() => navigation.navigate('MisBoletos')}>
